...
export function encryptBytes(data, passphrase) {
...
export function encryptFile(data, passphrase) {
 ...
 * journal records.
 */
export function decryptBytes(data, passphrase) {
    const key = deriveKey(passphrase);
 ...
 */
export function decryptFile(data, passphrase) {
...
export function validatePassphrase(data, passphrase) {
    try {
